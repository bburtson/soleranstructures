...
namespace VirtualTablesTest.Services
{
    ...
    public class ContextFactory : IContextFactory
    {
        ...
        /// <inheritdoc />
        public IDbContext DbContext => new WorkTestDbContext(ChangeDatabaseNameInConnectionString(this.TenantId).Options);
        ...
        private DbContextOptionsBuilder<WorkTestDbContext> ChangeDatabaseNameInConnectionString(string tenantId)
        {
            ...
            var contextOptionsBuilder = new DbContextOptionsBuilder<WorkTestDbContext>();
